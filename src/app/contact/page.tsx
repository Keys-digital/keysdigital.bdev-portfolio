...
const onSubmit = async (formData: ContactFormData) => {
  try {
    ...
    const data = await response.json(); // Parse response correctly
  ...
  return (
    ...
    >
      ...
      <section className="flex flex-col lg:flex-row items-center justify-between w-full max-w-6xl gap-12 py-12">
        ...
        >
          <h1 className="text-6xl font-extrabold tracking-wider uppercase mt-35 text-white stroke-gray-800 drop-shadow-[2px_2px_0px_rgba(31,41,55,1)] glow-gold">LIGHT IKOYO</h1>
...
<section className="mt-6 w-full max-w-2xl">
  <div className="bg-teal-900/60 border border-teal-600 rounded-lg p-6 shadow-lg backdrop-blur-md">
    ...
    <ul className="space-y-4">
      ...
      <li className="flex items-center gap-4">
        ...
        <span className="text-xl font-bold text-gray-200 text-white stroke-gray-800 drop-shadow-[1px_1px_0px_rgba(31,41,55,1)]">
          ...
          <span className="text-blue-300"> (AWS, Kubernetes, Docker, CI/CD)</span>
        </span>
      </li>
      ...
      <li className="flex items-center gap-4">
        ...
        <span className="text-xl font-bold text-gray-200 text-white stroke-gray-800 drop-shadow-[1px_1px_0px_rgba(31,41,55,1)]">
          Security & Authentication 
          <span className="text-blue-300"> (OAuth, JWT, Zero Trust Security)</span>
        </span>
      </li>
    </ul>
    ...
    <p className="mt-6 text-gray-300 text-lg leading-relaxed text-white stroke-gray-800 drop-shadow-[1px_1px_0px_rgba(31,41,55,1)]">
      Build **scalable, secure, and cloud-optimized backend systems** with high-performance APIs, 
      advanced authentication <span className="text-blue-300">(OAuth, JWT, RBAC)</span>, and cloud-native 
      deployment using <span className="text-blue-300">AWS, Docker, and CI/CD</span>. 
      Ensure **reliability, security, and efficiency** for seamless business operations.
    </p>
    ...
    <p className="mt-4 text-gray-200 text-lg text-white stroke-gray-800 drop-shadow-[1px_1px_0px_rgba(31,41,55,1)]">
      ...
      <a href="mailto:your.email@example.com" className="text-yellow-400 text-xl hover:underline">
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center px-6">
        <div className="text-gray-300">
          <h3 className="3xl font-extrabold text-white drop-shadow-md">10+</h3>
          <p className="text-lg text-gray-400">Projects Completed</p>
        </div>
        <div className="text-gray-300">
          <h3 className="3xl font-extrabold text-white drop-shadow-md">12+</h3>
          <p className="text-lg text-gray-400">Client Feedbacks</p>
        </div>
        <div className="text-gray-300">
          <h3 className="text-2xl font-extrabold text-white drop-shadow-md">50+</h3>
